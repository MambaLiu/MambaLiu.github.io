...
function IndexComponent_div_28_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](7, IndexComponent_div_28_ng_container_7_Template, 3, 1, "ng-container", 23);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
...
class IndexComponent {
    constructor() {
        this.connectList = [
            ...
            },
            {
                ...
                isDetailPic: false,
                isClickDown: false,
                detail: 'blog.csdn.net/weixin_45213401',
    ...
    pushDown(title, index, detailTitle) {
        ...
        arr2.setAttribute('style', 'opacity:1');
    ...
    pullUp(title, index, detailTitle) {
        ...
        var arr2 = document.querySelector('#' + detailTitle);
        arr2.setAttribute('style', 'opacity:0');
        this.lastTimeTitle = title;
        this.lastTimeIndex = index;
        this.lastTimeDetailTitle = detailTitle;
    }
...
IndexComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: IndexComponent, selectors: [["app-index"]], decls: 29, vars: 13, consts: [[1, "bacground"], [1, "out"], [1, "glass"], [1, "dash-board"], [1, "up"], [1, "me"], [1, "per-pic"], [1, "per-galss"], [1, "zh-name", "per-detail"], ["src", "../../assets/img/icon/\u59D3\u540D.png"], [1, "per-detail"], ["src", "../../assets/img/icon/\u6635\u79F0.png"], ["src", "../../assets/img/icon/\u5BB6.png"], ["src", "../../assets/img/icon/\u5730\u70B9.png"], ["src", "../../assets/img/icon/\u804C\u4E1A.png"], [1, "links"], ["class", "container", 4, "ngFor", "ngForOf"], [1, "container"], [1, "link", 3, "id", "click"], [3, "src"], [1, "outside", 3, "id"], [1, "arrow"], [1, "link-detail-out"], [4, "ngIf"], [1, "link-detail-text"]], template: function IndexComponent_Template(rf, ctx) { if (rf & 1) {
